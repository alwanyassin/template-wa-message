          ...
          <div className="flex items-center justify-between mb-1.5">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-[11px] text-emerald-700 hover:text-emerald-800 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded-md font-semibold transition flex items-center gap-1 cursor-pointer active:scale-[0.98] whitespace-nowrap"
